...
public class Trilha_1_Tela_0 extends AppCompatActivity {
    // Definindo cores personalizadas menos saturadas
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trilha1_tela0);
    ...
    private void redirecionarParaProximaTela() {
        salvarPontos();
        Intent intent = new Intent(this, Trilha_1_Tela_1.class);
