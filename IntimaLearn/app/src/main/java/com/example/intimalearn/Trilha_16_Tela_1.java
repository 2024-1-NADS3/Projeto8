...
public class Trilha_16_Tela_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trilha16_tela1);
    ...
    private void redirecionarParaProximaTela() {
        salvarPontos();
        Intent intent = new Intent(this, Trilha_16_Tela_2.class);
