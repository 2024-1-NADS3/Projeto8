...
public class Artigos_Item_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artigos_item4);

        Button button = findViewById(R.id.visitarSite);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://www.amazon.com.br/N%C3%A3o-me-toca-seu-boboca/dp/8595260036";
    ...
    private void voltarTelaAnterior() {
        ...
        Intent intent = new Intent(Artigos_Item_4.this, Artigos_Item_3.class);
        startActivity(intent);
    ...
    private void avancarProximaTela() {
        ...
        Intent intent = new Intent(Artigos_Item_4.this, MainActivity.class);
        startActivity(intent);
        // Fechar a tela atual (tela splash 2)
        finish();
    }
