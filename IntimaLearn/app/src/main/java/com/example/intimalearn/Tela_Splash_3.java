...
public class Tela_Splash_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_splash3);
    ...
    private void voltarTelaAnterior() {
        ...
        Intent intent = new Intent(Tela_Splash_3.this, Tela_Splash_2.class);
    ...
    private void avancarProximaTela() {
        ...
        Intent intent = new Intent(Tela_Splash_3.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
}