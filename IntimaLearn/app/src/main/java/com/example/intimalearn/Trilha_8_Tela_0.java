...
public class Trilha_8_Tela_0 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trilha8_tela0);
        ...
        opcao03.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pontos += 5;
                opcao03.setBackgroundTintList(ColorStateList.valueOf(lessSaturatedGreen)); // Define o botão como verde menos saturado
    ...
    private void redirecionarParaProximaTela() {
        salvarPontos();
        Intent intent = new Intent(this, Trilha_8_Tela_1.class);
