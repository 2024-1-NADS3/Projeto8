...
public class Trilha_7_Tela_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trilha7_tela1);
        ...
        opcao02.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pontos += 5;
                opcao02.setBackgroundTintList(ColorStateList.valueOf(lessSaturatedGreen)); // Define o botão como verde menos saturad
    ...
    private void redirecionarParaProximaTela() {
        salvarPontos();
        Intent intent = new Intent(this, Trilha_7_Tela_2.class);
