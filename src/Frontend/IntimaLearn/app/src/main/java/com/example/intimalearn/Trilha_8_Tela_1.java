...
public class Trilha_8_Tela_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trilha8_tela1);
        ...
        opcao04.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pontos += 5;
                opcao04.setBackgroundTintList(ColorStateList.valueOf(lessSaturatedGreen)); // Define o botão como verde menos saturado
    ...
    private void redirecionarParaProximaTela() {
        salvarPontos();
        Intent intent = new Intent(this, Trilha_8_Tela_2.class);
