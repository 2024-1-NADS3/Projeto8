...
public class Trilha_1_Tela_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trilha1_tela3);
        enviarResultado();
    ...
    public void InicioTrilha(View view) {
        // Desbloquear a segunda fase
        desbloquearFase2();

        // Retornar ao início
        Intent intent = new Intent(Trilha_1_Tela_3.this, MainActivity.class);
    ...
    private void desbloquearFase2() {
        SharedPreferences prefs = getSharedPreferences("MyPrefs3", MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putBoolean("Fase2Unlocked3", true);
        editor.apply();
    }
