...
public class Trilha_3_Tela_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trilha3_tela3);
        enviarResultado();
    ...
    public void InicioTrilha(View view) {
        desbloquearFase4();
        Intent intent = new Intent(Trilha_3_Tela_3.this, MainActivity.class);
    ...
    private void desbloquearFase4() {
        SharedPreferences prefs4 = getSharedPreferences("MyPrefs5", MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs4.edit();
        editor.putBoolean("Fase4Unlocked3", true);
        editor.apply();
    }
